...
export default function ProfileHero() {
  return (
    <section className="space-y-6">
      <div className="rounded-lg bg-linear-to-br from-stone-100/80 via-gray-100 to-slate-100 p-7 pb-9 flex flex-col items-center justify-center gap-4 lg:gap-5 lg:min-h-95">
